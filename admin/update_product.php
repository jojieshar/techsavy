          ...
          <div class="col">
            <div class="card shadow">
              <div class="card-header border-0">
                <h3>Fill in all necessary details</h3>
              </div>
              <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-row">
                    <div class="col-md-6">
                      ...
                      <input type="file" name="prod_img" class="btn  form-control" value="<?php echo $prod_img; ?>" style="border: 2px solid #fb6340;"> 
                    </div>
                    <div class="col-md-6">
                  ...
                  <div class="form-row">
                    <div class="col-md-6">
                      <input type="submit" name="UpdateProduct" value="Update Product" class="btn text-white" value="" style="background-color: #fb6340;">
                    </div>
                  </div>
                </form>
              </div>
