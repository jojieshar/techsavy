              ...
              <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    ...
                    <input type="file" name="prod_img" class="btn form-control" value="" style="border: 2px solid #fb6340;">
                  </div>
                  <div class="col-md-6">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="addProduct" value="Add Product" class="btn text-white" value="" style="background-color: #fb6340;">
                  </div>
                </div>
              </form>
            </div>
