...
<body class="bg-dark">
  <div>
    <div class="main-content">
      ...
      <!-- Page content -->
      <div class="container mt--8 pb-5" style="position: relative; top: -50px;">
        <div class="row justify-content-center">
          <div class="col-lg-5 col-md-7">
              ...
              <div class="card-body px-lg-5 py-lg-5">
                <form method="post" role="form">
                  ...
                  <div class="text-center">
                    <button type="submit" name="reset_pwd" class="btn btn-primary my-4"  style="background-color: #fb6340; border: none; width: 350px;">Submit</button>
                  </div>
                </form>
              </div>
            </div>
            <div class="row mt-3">
              <div class="col-6">
                <a href="index.php"  style="color: #fb6340; text-decoration: underline;"><small>Log In?</small></a>
              </div>
            </div>
          </div>
        </div>
...
<footer class="py-5">
  <div class="container"  style="position: relative;top: 10px; left: 400px;">
